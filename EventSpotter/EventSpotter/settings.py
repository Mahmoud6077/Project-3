"""
Django settings for EventSpotter project.
...
SECRET_KEY = 'django-insecure-&@vlq)!mswq@at6i1ko=2ojqkq13wey)*ygye@hc*^m^-d=-o+'
...
ROOT_URLCONF = 'EventSpotter.urls'
...
WSGI_APPLICATION = 'EventSpotter.wsgi.application'
